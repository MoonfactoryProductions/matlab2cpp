def code(namespace = "std"):
   result = r"""#ifndef MCONVERT_H
   #define MCONVERT_H
   ...
   namespace m2cpp {
       ...
       */
       ...
       inline void intersect(arma::Col<typename T::elem_type>& C, arma::uvec& ia, arma::uvec& ib, const T& a, const T& b) {
          ...
          """ + namespace + r"""::vector<eT> C_;
          """ + namespace + r"""::vector<arma::uword> ia_, ib_;
       ...
       inline void unique_rows_core(Tr& C, Tr& a_sorted, arma::uvec& ia, const T& a) {
          ...
          """ + namespace + r"""::vector<arma::uword> ia0, ia1;
   
          """ + namespace + r"""::vector<arma::uword>* ia_ = &ia0;
          """ + namespace + r"""::vector<arma::uword>* ia_prev_ = &ia1;
   ...
   #undef FUNC2D
       ...
       template <typename T>
       inline """ + namespace + r"""::string to_string(const T &item)
       {
           return Stringifier<T>::to_string(item);
       }
   
       template <typename T1>
       inline """ + namespace + r"""::string mat_to_string(const arma::Base<typename T1::elem_type,T1> &item)
       {
           return Stringifier<arma::Base<typename T1::elem_type,T1>>::to_string(item);
       }
   
       template <typename T1>
       inline """ + namespace + r"""::string mat_to_string(const arma::Mat<T1> &item)
       {
           return Stringifier<arma::Mat<T1>>::to_string(item);
       }
   
        inline """ + namespace + r"""::string mat_to_string(const arma::SizeMat &item)
       {
       ...
       inline """ + namespace + r"""::string sprintf(const char* format, ...)
       {
           """ + namespace + r"""::string result;
